# AI AGENT DIRECTIVES - CLOUD VS CODE WORKSTATION SUBMODULE (2026 CLEAN ARCHITECTURE)

> ⚠️ **CRITICAL SUBMODULE GOVERNANCE NOTICE FOR ALL AI SESSIONS & LLMs**
> This repository is an INDEPENDENT, STANDALONE CLOUD VS CODE WORKSTATION SUBMODULE.
