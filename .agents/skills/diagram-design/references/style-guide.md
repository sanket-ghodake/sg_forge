...
|---|---|---|---|
| `paper` | Page background, default node fill | `#f8fafc` (Astryx Light Root) | `#090d16` (Astryx Dark Root) |
| `paper-2` | Diagram container bg, secondary fill | `#f1f5f9` (Astryx Surface) | `#0f172a` (Astryx Surface Dark) |
| `ink` | Primary text, primary stroke | `#0f172a` (Astryx Dark Slate) | `#f8fafc` (Astryx Light Slate) |
| `muted` | Secondary text, default arrow stroke | `#64748b` (Astryx Muted Slate) | `#94a3b8` (Astryx Slate Light) |
| `soft` | Sublabels, boundary labels | `#94a3b8` | `#64748b` |
| `rule` | Hairline borders | `rgba(15, 23, 42, 0.12)` | `rgba(248, 250, 252, 0.12)` |
| `rule-solid` | Stronger borders, baselines | `#e2e8f0` (Astryx Border Light) | `#1e293b` (Astryx Border Dark) |
| `accent` | Focal / 1–2 max per diagram | `#6366f1` (Astryx Indigo 500) | `#818cf8` (Astryx Indigo 400) |
| `accent-tint` | Fill for accent-bordered boxes | `rgba(99, 102, 241, 0.08)` | `rgba(129, 140, 248, 0.12)` |
| `link` | HTTP/API calls, external arrows | `#0284c7` (Astryx Sky 600) | `#38bdf8` (Astryx Sky 400) |

> **Brand palette source:** this skin maps directly to **Astryx Design System** tokens (`--forge-bg-root`, `--forge-bg-surface`, `--forge-text-main`, `--forge-text-muted`, `--forge-border`, `--forge-primary`). All editorial diagrams produced natively match `@forge/portal` and `@forge/ui`.
