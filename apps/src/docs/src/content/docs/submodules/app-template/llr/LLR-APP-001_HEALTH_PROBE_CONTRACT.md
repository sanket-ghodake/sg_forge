---
title: "LLR-APP-001: Dual-Probe Health & Readiness Contract"
...
<div style="margin-bottom: 1.5rem;">
  <TraceabilityBadge reqId="LLR-APP-001" type="LLR" status="verified" />
</div>
...
> **Low-Level Requirement (LLR)** | Status: `VERIFIED` | Traceability ID: `[LLR-APP-001]`
