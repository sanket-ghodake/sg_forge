/**
 * SG Forge Lifetime Token & Spend Dashboard
 * Enterprise Clean Architecture (2026 LTS)
 *
 * Renders the persistent repository-wide AI token and cost metrics
 * across all tools and agent sessions.
 */
...
function renderDashboard() {
  ...
  console.log(`\n\x1b[1;36m========================================================================================\x1b[0m`);
  console.log(`\x1b[1;37m 🔥 SG FORGE REPOSITORY LIFETIME TOKEN & SPEND LEDGER\x1b[0m`);
  ...
  console.log(`   └─ Storage Invariant:  Git-committed (preserved across laptop/server migration)`);
  ...
  console.log(`\n\x1b[1;37m📜 RECENT REPOSITORY SESSIONS:\x1b[0m`);
  ...
  console.log(`\n\x1b[1;30mTip: Run \x1b[1;33m./run.sh tokens tui\x1b[0m\x1b[1;30m for interactive CodeBurn dashboard\x1b[0m\n`);
}
