...
const tools: ToolTest[] = [
  ...
  { name: 'Astryx Validator', command: ['bun', './portables/bin/astryx', 'status'], category: 'UI & Design System' },
  ...
  { name: 'Spectral OpenAPI Linter', command: ['./portables/bin/spectral', 'lint', 'apps/src/docs/api/openapi.yaml'], category: 'API Contracts' },
  ...
  { name: 'SCC Code Counter', command: ['./portables/bin/scc', 'apps/src/docs/'], category: 'Metrics' },
